...
const CreatTypeProduct = (props) =>{
    ...
    const addData = async(e)=>{
        ...
        if(props.isEditing==true){
            res = await axios.post(`http://localhost:8000/api/loaisanpham/${maloaisp}`,formData,config);          
        }
        else{
            res = await axios.post("http://localhost:8000/api/loaisanpham",formData,config);            
        }
            ...
            <div className='container'>
                ...
                <Form.Group>
                    ...
                    <Form.Group className="mb-1">
                        ...
                        <Form.Control type="text" name='tenloaisp' onChange={settenloaisp} defaultValue={tenloaisp}/>
                    </Form.Group>
                </Form.Group>
                </Form>   
                <button className='btn btn-primary save-type' variant="primary" type="submit" onClick={addData}>
